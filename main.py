...
TEXTS = {
    "en": {
        ...
        "nationality_options": ["African", "American", "Arabian", "Argentinan", "Asian", "Belgian", "Chinese", "Colombian", "Ecuatorian", "English", "European", "French", "German", "Indian", "Italian", "Japanese", "Korean", "Moroccan", "Dutch", "Pakistanian", "Peruvian", "Polish", "Portuguese", "Romanian", "Russian", "Spanish", "Turkish", "Ukranian", "Venezuelan"],
